...
INSERT INTO `user` (`email`,`active`,`first_name`,`last_name`,`password`, `salt`, `role`)
	VALUES ('cprg352+admin@gmail.com', true, 'Admin','Admin', 'password', 'password', 1);
INSERT INTO `user` (`email`,`active`,`first_name`,`last_name`,`password`,`salt`, `role`)
	VALUES ('cprg352+admin2@gmail.com', true, 'Admin2','Admin2', 'password', 'password', 3);
INSERT INTO `user` (`email`,`active`,`first_name`,`last_name`,`password`,`salt`, `role`)
	VALUES ('cprg352+anne@gmail.com', true, 'Anne','Annerson', 'password', 'password', 2);
INSERT INTO `user` (`email`,`active`,`first_name`,`last_name`,`password`,`salt`, `role`)
	VALUES ('cprg352+barb@gmail.com', true, 'Barb','Barber', 'password', 'password', 2);
